...
var arregloLibros : Array<Array<String>> = Array<Array<String>>()
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    @IBAction func buscarLibro(sender: AnyObject) {
        ...
        performSegueWithIdentifier("buscarLibro", sender: self)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "showDetail" {
            ...
            controller.tipoDetalle = 1
            if let indexPath = self.tableView.indexPathForSelectedRow {
                controller.isbnBuscar = arregloLibros[indexPath.row][1]
            }
        }
    }
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return arregloLibros.count
    }

    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Cell", forIndexPath: indexPath)
        //self.configureCell(cell, atIndexPath: indexPath)
        cell.textLabel!.text = arregloLibros[indexPath.row][0]
